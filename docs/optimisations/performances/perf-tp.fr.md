...
- [access_log_NASA_Jul95](assets/access_log_NASA_Jul95.gz) contient les logs du mois de juillet 1995 d'un serveur de la NASA
  (~2mios d'entrées)
- [access_log_NASA_Jul95_samples](assets/access_log_NASA_Jul95_samples.gz) contient les 200'000 premières entrées du fichier
  précédent.
